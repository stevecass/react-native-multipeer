  ...
  constructor() {
    ...
    var peerFound = DeviceEventEmitter.addListener(
      ...
      ((event) => {
        ...
        console.log('found peers', this._peers);
      }).bind(this));
    ...
    var peerLost = DeviceEventEmitter.addListener(
      ...
      ((event) => {
        ...
        console.log('PeerLost', event, this._peers, this._connectedPeers);
    ...
    var peerConnected = DeviceEventEmitter.addListener(
      ...
      ((event) => {
        console.log('conected', event, this._peers, this._connectedPeers);
    ...
    var peerConnecting = DeviceEventEmitter.addListener(
      ...
      ((event) => {
        console.log('connecting', event, this._peers, this._connectedPeers);
        if (this._peers[event.peer.id]) {
    ...
    var peerDisconnected = DeviceEventEmitter.addListener(
      ...
      ((event) => {
        console.log('disconnected', event, this._peers, this._connectedPeers);
        if (this._peers[event.peer.id]) {
